"use strict";
let Basket = document.querySelector('.cartIconWrap'),
    basketItem = document.querySelector('.basket'),
    basketCounter = document.querySelector('.cartIconWrap span'),
    basketTotal = document.querySelector('.basketTotal'),
    basketTotalValue = document.querySelector('.basketTotalValue');
